...
namespace QuanLyQuanCafe
{
    public partial class fAdmin : Form
    {
        ...
        void Load()
        {
            ...
            dtgvFood.Columns[2].DataPropertyName = "Price";
            dtgvFood.Columns[3].DataPropertyName = "CategoryID";
        ...
        private void txbFoodID_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int id_row = (int)dtgvFood.SelectedCells[0].RowIndex;
                    int id = (int)dtgvFood.Rows[id_row].Cells[3].Value;
